    ...
    def hasPathSum(self, root: TreeNode, targetSum: int) -> bool:
        ...
        def dfs(root: TreeNode, sum):
            ...
            if root.left and dfs(root.left, sum):
                return True
            if root.right and dfs(root.right, sum):
                return True
            return False
...
print(sol.hasPathSum(TreeNode(5, TreeNode(4, TreeNode(11, TreeNode(7), TreeNode(2))), TreeNode(8, TreeNode(13), TreeNode(4, None, TreeNode(1)))), 22))
